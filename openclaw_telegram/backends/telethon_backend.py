...
try:
    ...
    raise ImportError(
        "Telethon backend requires telethon. " "Install with: pip install telethon qrcode"
    )
...
class TelethonBackend(BaseBackend):
    ...
    async def authorize_qr(self, timeout: int = 300) -> bool:
        ...
        try:
            ...
            raise AuthenticationError("2FA is enabled. Please use phone/code login instead.")
        except Exception as e:
